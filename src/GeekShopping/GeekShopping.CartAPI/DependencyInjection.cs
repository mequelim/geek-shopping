using AutoMapper;
using GeekShopping.CartAPI.Configs.Mappings;
using GeekShopping.CartAPI.Infrastructure.Database;
using GeekShopping.CartAPI.RabbitMQ.Sender;
using GeekShopping.CartAPI.RabbitMQ.Sender.Interface;
using GeekShopping.CartAPI.Repository;
using GeekShopping.CartAPI.Repository.Interfaces;
using GeekShopping.CartAPI.Shared.Converters;
using GeekShopping.CartAPI.Shared.Extensions;
    ...
    public static class DependencyInjection
    {
        ...
        extension(WebApplicationBuilder builder)
        {
            ...
            public WebApplicationBuilder AddApiServices()
            {
                ...
                //* Services:
                builder.Services.AddHttpClient<ICouponRepository, CouponRepository>((service) =>
                    service.BaseAddress = new Uri(builder.Configuration["ServicesUrls:DiscountCouponAPI"]!)
                );
        ...
        public static WebApplication UseApi(this WebApplication application)
        {
            ...
            if(application.Environment.IsDevelopment())
            {
                ...
                application.MapScalarApiReference((options) =>
                {
                    ...
                    options.Title = "GeekShopping - CartAPI";
                });
            }
