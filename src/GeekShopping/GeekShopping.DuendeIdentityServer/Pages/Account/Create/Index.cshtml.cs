...
namespace GeekShopping.DuendeIdentityServer.Pages.Account.Create
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class Index : PageModel
    {
        ...
        )
        {
            ...
            _users = users
                     ?? throw new InvalidOperationException("Please call 'AddTestUsers(TestUsers.Users)' on the IIdentityServerBuilder in Startup or remove the TestUserStore from the AccountController.");
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            {
                TestUser? user = _users.CreateUser(Input.Username, Input.Password, Input.Name, Input.Email);
