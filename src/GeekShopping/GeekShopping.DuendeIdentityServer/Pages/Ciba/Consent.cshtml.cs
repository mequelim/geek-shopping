...
namespace GeekShopping.DuendeIdentityServer.Pages.Ciba
{
    [Authorize]
    [SecurityHeaders]
    public class Consent : PageModel
    {
        ...
        {
            // Validates return url is still valid:
            BackchannelUserLoginRequest? request = await _interaction
                .GetLoginRequestByInternalIdAsync(Input.Id ?? throw new ArgumentNullException(nameof(Input.Id)));
            ...
            {
                // Communicate outcomes of consent back to IdentityServer:
        ...
        private ViewModel CreateConsentViewModel(BackchannelUserLoginRequest request)
        {
            ...
            IEnumerable<ApiResource> apiResources = request
                .ValidatedResources
                .Resources
                .ApiResources
