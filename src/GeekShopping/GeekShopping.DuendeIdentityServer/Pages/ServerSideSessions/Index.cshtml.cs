...
namespace GeekShopping.DuendeIdentityServer.Pages.ServerSideSessions
{
    public class IndexModel : PageModel
    {
        ...
        {
            // Replaces it with an authorization policy check:
            if(HttpContext.Connection.IsRemote()) return NotFound();

            if(_sessionManagementService is not null)
            {
