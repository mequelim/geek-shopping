...
using GeekShopping.OrderAPI.RabbitMQ.Consumer;
using GeekShopping.OrderAPI.RabbitMQ.Sender;
using GeekShopping.OrderAPI.RabbitMQ.Sender.Interface;
using GeekShopping.OrderAPI.Repository;
using GeekShopping.OrderAPI.Repository.Interfaces;
using GeekShopping.OrderAPI.Shared.Converters;
using GeekShopping.OrderAPI.Shared.Extensions;
...
namespace GeekShopping.OrderAPI
{
    ...
    public static class DependencyInjection
    {
        ...
        extension(WebApplicationBuilder builder)
        {
            ...
            /// <remarks>
            /// This method registers and configures essential services for the API, including JSON serializer options, AutoMapper, repositories, controllers, and Scalar for
            /// API documentation.
            ...
            /// The AddHostedService method, in C# .NET, is the standard way to register background services in application dependency injection, allowing tasks to run asynchronously while the server
            /// processes requests.
            /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This method sets up essential middleware and configurations for the application, including request localization, HTTPS redirection, routing, CORS policy, request handling, authentication,
        /// authorization, custom middlewares, and controller mapping.
        ...
        public static WebApplication UseApi(this WebApplication application)
        {
            ...
            if(application.Environment.IsDevelopment())
            {
                ...
                application.MapScalarApiReference((options) =>
                {
                    ...
                    options.Title = "GeekShopping - OrderAPI";
                });
            }
            ...
            {
                if(context.Request.Path.StartsWithSegments("/api/Cart/DeleteFromCart"))
                {
