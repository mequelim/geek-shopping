using AutoMapper;
using GeekShopping.DiscountCouponAPI.Configs.Mappings;
using GeekShopping.DiscountCouponAPI.Infrastructure.Database;
using GeekShopping.DiscountCouponAPI.Repository;
using GeekShopping.DiscountCouponAPI.Repository.Interfaces;
using GeekShopping.DiscountCouponAPI.Shared.Converters;
using GeekShopping.DiscountCouponAPI.Shared.Extensions;
...
namespace GeekShopping.DiscountCouponAPI
{
    /// <summary>
    ...
    public static class DependencyInjection
    {
        ...
        extension(WebApplicationBuilder builder)
        {
            ...
            /// </summary>
            /// <remarks>
            /// This method registers and configures essential services for the API, including JSON serializer options, AutoMapper, repositories, controllers, and Scalar for API documentation.
        ...
        public static WebApplication UseApi(this WebApplication application)
        {
            ...
            if(application.Environment.IsDevelopment())
            {
                ...
                application.MapScalarApiReference((options) =>
                {
                    ...
                    options.Title = "GeekShopping - DiscountCouponAPI";
                });
            }
