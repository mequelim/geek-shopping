...
namespace GeekShopping.DiscountCouponAPI.Shared.Converters
{
    /// <summary>
    ...
    /// <example>
    /// This converter can be registered in the <see cref="JsonSerializerOptions.Converters"/> collection to enable support for <see cref="TimeOnly"/> in JSON processing.
    /// </example>
